...
}): (peerId: import("peer-id"), options?: (PingSettings & import("ipfs-core-types").AbortOptions) | undefined) => AsyncIterable<Pong | PingFailure | StatusUpdate>;
export = _exports;
/**
...
export type PingOptions = PingSettings & import("ipfs-core-types").AbortOptions;
