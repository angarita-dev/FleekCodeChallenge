...
declare class IPFS {
    ...
    ipns: import("./ipns");
    pin: import("./pin");
    resolve: (path: string, opts?: (import("./resolve").ResolveSettings & import("ipfs-core-types").AbortOptions) | undefined) => Promise<string>;
    block: import("./block");
    refs: ((ipfsPath: import("ipfs-core-types/src/root").IPFSPath, options?: (import("./refs").RefsOptions & import("ipfs-core-types").AbortOptions) | undefined) => AsyncIterable<{
        ref: string;
        err?: null | undefined;
    } | {
        ref?: undefined;
    ...
    dht: {
        ...
        put: (key: Uint8Array, value: Uint8Array, options?: import("ipfs-core-types").AbortOptions | undefined) => AsyncIterable<import("./dht").QueryEvent>;
        findProvs: (cid: import("cids"), options?: (import("./dht").FindProvsOptions & import("ipfs-core-types").AbortOptions) | undefined) => AsyncIterable<import("./dht").PeerInfo>;
        ...
        provide: (cids: import("cids") | import("cids")[], options?: (import("./dht").ProvideOptions & import("ipfs-core-types").AbortOptions) | undefined) => AsyncIterable<import("./dht").QueryEvent>;
    ...
    pubsub: {
        subscribe: (topic: string, handler: (message: import("./pubsub").Message) => void, options?: import("ipfs-core-types").AbortOptions | undefined) => Promise<void>;
        unsubscribe: (topic: string, handler?: ((message: import("./pubsub").Message) => void) | undefined, options?: import("ipfs-core-types").AbortOptions | undefined) => Promise<void>;
    ...
    dns: (domain: string, options?: (import("./dns").DNSSettings & import("ipfs-core-types").AbortOptions) | undefined) => Promise<string>;
    isOnline: () => boolean;
    id: (_options?: import("ipfs-core-types").AbortOptions | undefined) => Promise<import("./id").ID>;
    version: (options?: import("ipfs-core-types").AbortOptions | undefined) => Promise<import("./version").Version>;
    bitswap: import("./bitswap");
    bootstrap: import("./bootstrap");
    config: {
        getAll: (options?: import("ipfs-core-types").AbortOptions | undefined) => Promise<import("./config").IPFSConfig>;
        ...
        replace: (value: import("./config").IPFSConfig, options?: import("ipfs-core-types").AbortOptions | undefined) => Promise<void>;
        profiles: {
    ...
    ping: (peerId: import("peer-id"), options?: (import("./ping").PingSettings & import("ipfs-core-types").AbortOptions) | undefined) => AsyncIterable<import("./ping").Pong | import("./ping").PingFailure | import("./ping").StatusUpdate>;
...
type IPFSOptions = {
     ...
     * browsers.
     */
    libp2p?: Function | import("libp2p/src/").Libp2pOptions | undefined;
...
type StorageOptions = {
     ...
     */
    repo?: string | import("ipfs-core-types/src/repo").Repo<import("./config").IPFSConfig> | undefined;
    /**
...
type LibP2POptions = {
    modules: import("libp2p/src/").Libp2pModules;
    addresses?: import("libp2p/src/address-manager").AddressManagerOptions | undefined;
    connectionManager?: import("libp2p/src/connection-manager").ConnectionManagerOptions | undefined;
    dialer?: import("libp2p/src/dialer").DialerOptions | undefined;
    metrics?: import("libp2p/src/metrics").MetricsOptions | undefined;
    keychain?: any;
    transportManager?: import("libp2p/src/transport-manager").TransportManagerOptions | undefined;
    peerStore?: (import("libp2p/src/").PeerStoreOptions & import("libp2p/src/peer-store/persistent").PersistentPeerStoreOptions) | undefined;
    config?: import("libp2p/src/").Libp2pConfig | undefined;
...
type Resolve = (path: string, opts?: (import("./resolve").ResolveSettings & import("ipfs-core-types").AbortOptions) | undefined) => Promise<string>;
...
type DNS = (domain: string, options?: (import("./dns").DNSSettings & import("ipfs-core-types").AbortOptions) | undefined) => Promise<string>;
